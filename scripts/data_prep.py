...
def main() -> None:
    ...
    df_customers['join_date'] = pd.to_datetime(df_customers['join_date'], errors='coerce')  # Ensure join_date is datetime
    ...
    df_products['product_name'] = df_products['product_name'].str.strip()  # Trim whitespace from column values
